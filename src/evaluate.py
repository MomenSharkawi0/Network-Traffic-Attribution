"""Evaluate the trained attribution models and write figures.
...
def plot_roc(curves: dict) -> None:
    ...
    ax.set_title("ROC — Attribution models")
...
def evaluate_model(name: str, model, X_test, y_test) -> dict:
    ...
    for k, v in metrics.items():
        print(f"  {k:10s}: {v:.4f}")
    print(classification_report(y_test, y_pred, target_names=["spoof/decoy", "real"]))
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate attribution models.")
